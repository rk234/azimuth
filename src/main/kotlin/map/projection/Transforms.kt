...
inline fun aerToGeo(azimuth: Float, elevation: Float, range: Float, stationLat: Float, stationLon: Float): Vector2f {
...
inline fun antennaToCartesian(azimuth: Float, range: Float, elevation: Float): Vector3f {
